...
const GitGraph = () => {
  return (
    <a 
      ...
      className="w-full flex flex-col items-center justify-center mt-8 mb-4 gap-4 px-4 sm:px-6 md:px-8 lg:px-12 hover:opacity-90 transition-all cursor-pointer"
    >

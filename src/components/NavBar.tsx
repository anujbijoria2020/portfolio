...
import { CodeIcon, FileIcon, GithubIcon, HomeIcon, LinkedinIcon, NotebookIcon, Rows3Icon } from "lucide-react"
   ...
   <div className="rounded-full px-2 py-1 bg-white/10 backdrop-blur-lg border top-3 dark:border-white/20 flex items-center justify-center dark:shadow-none shadow w-[850px] max-[400px]:w-[345px] max-[350px]:w-[330px] max-[321px]:w-[310px] ">
        ...
        <Tooltip>
            <TooltipTrigger>
                  <div className='hover:px-3 max-sm:hover:px-2 py-2.5 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all duration-300'>
                                <HomeIcon className={`w-[19px] h-[19px] max-sm:w-[15px] max-sm:h-[15px] text-black dark:text-white 
       ...
       <Link href="/blogs">
        <Tooltip>
                        <TooltipTrigger>
                 <div className='hover:px-3 max-sm:hover:px-2 py-2.5 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all duration-300'>
                                <NotebookIcon className={`w-[19px] h-[19px] max-sm:w-[15px] max-sm:h-[15px] text-black dark:text-white 
...
/>
        ...
        <Tooltip>
                        <TooltipTrigger>
                 <div className='hover:px-3 max-sm:hover:px-2 py-2.5 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all duration-300'>
                                <FileIcon className={`w-[19px] h-[19px] max-sm:w-[15px] max-sm:h-[15px] text-black dark:text-white `} />
                            </div>
            </TooltipTrigger>
            <TooltipContent>
                <span>Resume</span>
        ...
        <Tooltip>
                        <TooltipTrigger>
                 <div className='hover:px-3 max-sm:hover:px-2 py-2.5 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all duration-300'>
                                <GithubIcon className={`w-[19px] h-[19px] max-sm:w-[15px] max-sm:h-[15px] text-black dark:text-white `} />
                            </div>
            </TooltipTrigger>
            <TooltipContent>
                <span>Github</span>
          ...
          <Link href="https://www.linkedin.com/in/anuj-kurmi-4774ab27a" target="_blank">
        <Tooltip>
                        <TooltipTrigger>
                 <div className='hover:px-3 max-sm:hover:px-2 py-2.5 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all duration-300'>
                                <LinkedinIcon className={`w-[19px] h-[19px] max-sm:w-[15px] max-sm:h-[15px] text-black dark:text-white `} />
                            </div>
            </TooltipTrigger>
            <TooltipContent>
                <span>LinkedIn</span>
...
<div className="hover:px-3 max-sm:hover:px-2 py-2.5 rounded-full transition-all duration-300 "

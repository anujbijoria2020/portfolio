        ...
        <div className='w-1/2 max-lg:w-full max-lg:px-20 max-sm:w-full max-sm:px-5 flex flex-col items-center mt-4 pb-8'>
...

            {
                educationData.map((edu: I_Education, idx) => (
                    <MagicCard key={idx} className="dark:shadow-2xl mt-5 !bg-transparent border-none" gradientColor={`${isDarkMode ? '#262626' : 'rgba(197, 241, 241, 0.4)'}`}>
...
export const educationData: I_Education[] = [
    {
        institute_link: "https://indoreinstitute.com/",
        institute_logo: "/iist.png",
        course_title: "Bachelors of Technology in Computer Science",
        ending_date: "Expected september 2027",
